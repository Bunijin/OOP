...
public class Queen extends Figure {
    ...
    public Queen(String name, char color, String position) {
    ...
    public void move(String destination, ChessBoard board) {
        ...
        if (Math.abs(currentX - destinationX) == Math.abs(currentY - destinationY) || currentX == destinationX
            ...
            if (board.board[destinationY][destinationX] == null
                ...
                if (board.board[destinationY][destinationX] != null) {
                    ...
                    System.out.println(
                            this.getName() + " has captured " + board.board[destinationY][destinationX].getName());
                } else {
            ...
            System.out.println("Invalid move for a Queen!");
        }
    }
}